...
const CommunityHero = () => {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center">
      ...
      <a href="/register"><button className="flex items-center gap-2 bg-white px-6 py-3 rounded-full border border-gray-300 font-medium hover:bg-gray-50 hover:shadow-md transition-all cursor-pointer">
        Join Now
